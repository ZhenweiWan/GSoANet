...
def main():
    ...
    if 'tdn' in args.arch:
        from ops.tdn_models import TSN
        model = TSN(num_class,
                    args.num_segments,
                    args.modality,
        ...
        from ops.tea_models import TSN
    ...
    # afm chnage dataset path
    args.root_path = "/home/zhang/dataset/S-S-V1/20bn-something-something-v1/"
    args.train_list = "/home/zhang/dataset/S-S-V1/train_videofolder.txt"
    args.val_list = "/home/zhang/dataset/S-S-V1/val_videofolder.txt"
    
    if 'tdn' in args.arch:
        from ops.tdn_dataset import TSNDataSet
    ...
    if 'tea' in args.arch:
        from ops.tea_dataset import TSNDataSet
    ...
    # afm make directory for storing checkpoint files
    '''
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # afm update stats
        '''
        stats_._update(train_loss, top1, top5, val_loss, prec1, prec5)
        plot_curve(stats_, os.path.join(args.stats_store_name), True)
        data = stats_
        sio.savemat(os.path.join(args.stats_store_name, 'stats.mat'), {'data': data})
        '''
        # afm add end
        ...
        if args.use_amp:
            ...
            if args.clip_gradient is not None:
                grad_norm = clip_grad_norm_(
                    amp.master_params(optimizer), args.clip_gradient)
        else:
            if args.clip_gradient is not None:
