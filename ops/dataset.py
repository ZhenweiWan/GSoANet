...
class TSNDataSet(data.Dataset):
    def __init__(self, root_path, list_file,
        ...
        if val:
            # self.root_path = '/home/vv/dataset/HMDB51/images'
            # self.root_path = '/media/vv/2TB/all_dataset/kinetics_frame_data/val_256'
            self.root_path = '/media/vv/2TB/all_dataset/ucf101_frame_data'
